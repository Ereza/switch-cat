...
**La traducció només s’ha provat amb la versió del sistema 22.0.0.**

Si la proveu amb qualsevol altra versió, no en garantim el correcte funcionament, i poden aparèixer errors que facin inutilitzable la consola. És possible que la traducció funcioni amb versions anteriors o posteriors del sistema operatiu, però probablement no funcionarà correctament amb versions diferents de la 22.x. Si hi ha una nova actualització del sistema, espereu a la publicació de l’actualització de la traducció o desinstal·leu-la abans d’actualitzar el sistema.
...
* Heu de tenir instal·lat [Atmosphère](https://github.com/Atmosphere-NX/Atmosphere) o qualsevol altre sistema similar que faci servir LayeredFS.
* Apagueu completament la consola, extraieu-ne la targeta microSD, inseriu-la a l’ordinador i extraieu el contingut de la baixada directament dins de la carpeta "atmosphere" de la targeta microSD. Torneu a inserir-la a la consola i torneu-la a engegar. També podeu fer servir [FTP](https://github.com/mtheall/ftpd) o la compartició de fitxers per USB pròpia d’Atmosphère per a evitar extreure i inserir la targeta microSD (si feu això, reinicieu completament la consola després de copiar-hi els fitxers).
...
* Als creadors d’[Atmosphère](https://github.com/Atmosphere-NX/Atmosphere), [Goldleaf](https://github.com/XorTroll/Goldleaf), [hactool](https://github.com/SciresM/hactool), [MSBT Editor Reloaded](https://github.com/IcySon55/3DLandMSBTeditor), [nxdumptool](https://github.com/DarkMatterCore/nxdumptool), [SARC Tool](https://github.com/aboood40091/SARC-Tool), [Switch-Toolbox](https://github.com/KillzXGaming/Switch-Toolbox), [Uwizard](https://github.com/MrMysterio/Uwizard) i la resta d’utilitats necessàries per a fer aquesta traducció.
